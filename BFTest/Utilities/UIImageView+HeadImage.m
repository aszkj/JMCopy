...
- (void)imageWithUsername:(NSString *)username placeholderImage:(UIImage*)placeholderImage
{
    ...
    if (profileEntity) {
        [self setImageWithURL:[NSURL URLWithString:profileEntity.imageUrl] placeholderImage:placeholderImage];
    } else {
        [self setImageWithURL:nil placeholderImage:placeholderImage];
    }
}
