                           ...
                           modelForMessage:(EMMessage *)message
{
    ...
    BFUserInfoModel *userModel = [BFHXManager getUserInfoWithOtherJmid:model.message.conversationId];
    if (userModel) {
...
- (void)backAction
{
    ...
    [[BFHXManager shareManager].delegateManager setChatVC:nil];
...
- (BOOL)viewController:(EMChooseViewController *)viewController didFinishSelectedSources:(NSArray *)selectedSources
{
    if ([selectedSources count]) {
        ...
        [BFHXManager getUserInfoWithOtherJmid:target.userId];
        if (_selectedCallback) {
