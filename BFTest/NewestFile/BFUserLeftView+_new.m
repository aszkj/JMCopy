...
#import "BFUserLeftView+_new.h"

@implementation BFUserLeftView (_new)
...
//    NSString *name = manager.name;
    ...
    if (imgStr != nil && imgStr.length > 0) {
        ...
        [iconImageView sd_setImageWithURL:imgUrl];
        ...
        iconImageView.image = BFIcomImg;
        nameLabel.text = @"请编辑用户名";
        assign.text = @"我的签名...";
        
    }
    view.baseImage = iconback;
    [view generateBlurFramesWithCompletion:^{
        
        dispatch_async(dispatch_get_main_queue(), ^{
        });
        [view blurInAnimationWithDuration:0.25f];
