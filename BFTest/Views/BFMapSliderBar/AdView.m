...
- (void)willMoveToSuperview:(UIView *)newSuperview
{
    ...
    if (!newSuperview || !self.scrollEnabled)
    {
...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _centerAdLabel.frame = CGRectMake(10, kAdViewHeight - 30, kAdViewWidth-20, 30);
...
//    _pageControl.currentPageIndicatorTintColor = NB_BASE_COLOR;
    ...
    }else if(PageControlShowStyle == UIPageControlShowStyleUp){
        
        _pageControl.frame = CGRectMake(0, 0, 20*_pageControl.numberOfPages, 20);
        _pageControl.center = CGPointMake(kAdViewWidth/2.0, 10);
    }else{
        _pageControl.frame = CGRectMake(0, 0, 20*_pageControl.numberOfPages, 20);
