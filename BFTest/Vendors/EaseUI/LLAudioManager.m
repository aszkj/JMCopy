...
+ (NSURL *)amrPathWithName:(NSString *)fileName {
    NSURL *amrTmpFolder = [BFChatHelper createFolderWithName:AMR_AUDIO_TMP_FOLDER inDirectory:[BFChatHelper dataPath]];
    if (!amrTmpFolder) {
        return nil;
    }
...
+ (NSURL *)wavPathWithName:(NSString *)fileName {
    NSURL *wavTmpFolder = [BFChatHelper createFolderWithName:WAV_AUDIO_TMP_FOLDER inDirectory:[BFChatHelper dataPath]];
    if (!wavTmpFolder) {
        return nil;
    }
