                         ...
                         model:(id<IMessageModel>)model
{
    ...
    [_statusButton setImage:[UIImage imageNamed:@"messageSendOrFailed"] forState:UIControlStateNormal];
    [_statusButton setImage:[UIImage imageNamed:@"messageSendRead"] forState:UIControlStateSelected];
...
//    _bubbleView.backgroundColor = [[UIColor redColor]colorWithAlphaComponent:0.5];
...
+ (CGFloat)cellHeightWithModel:(id<IMessageModel>)model
{
    ...
    switch (model.bodyType) {
        case EMMessageBodyTypeText:
        {
            ...
            height += (rect.size.height > 20 ? rect.size.height : 5) + 5;
