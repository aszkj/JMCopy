...
- (void)layoutSubviews
{
    ...
    switch (self.model.bodyType) {
        ...
        case EMMessageBodyTypeImage:
        {
            ...
            self.bubbleWithImageConstraint = [NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:retSize.width + margin + 5*ScreenRatio];
            [self addConstraint:self.bubbleWithImageConstraint];

            /*
            [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeHeight relatedBy:NSLayoutRelationEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:retSize.width + margin + 5*ScreenRatio]];
             */
        }
            break;
...
- (void)configureSendLayoutConstraints
{
    ...
    */
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeBottom relatedBy:NSLayoutRelationEqual toItem:self.contentView attribute:NSLayoutAttributeBottom multiplier:1.0 constant:- 9*ScreenRatio]];
...
- (void)setModel:(id<IMessageModel>)model
{
    ...
    NSURL *avatar = [NSURL URLWithString:model.message.ext[@"userIcon"]];
    
    [self.avatarView sd_setImageWithURL:avatar placeholderImage:BFIcomImg];
