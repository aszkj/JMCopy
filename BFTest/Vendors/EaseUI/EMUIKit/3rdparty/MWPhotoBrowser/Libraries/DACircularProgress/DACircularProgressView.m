...
- (void)drawInContext:(CGContextRef)context
{
    ...
    CGFloat radians = progress / 1.0f * 2.0f * M_PI;
    
    CGContextSetFillColorWithColor(context, self.trackTintColor.CGColor);
    CGMutablePathRef trackPath = CGPathCreateMutable();
    CGPathMoveToPoint(trackPath, NULL, centerPoint.x, centerPoint.y);
    CGPathAddArc(trackPath, NULL, centerPoint.x, centerPoint.y, radius, 0.0f, (float)(2.0f * M_PI), NO);
    ...
    if (progress > 0.0f)
    {
        ...
        CGPathAddArc(progressPath, NULL, centerPoint.x, centerPoint.y, radius, - M_PI / 2, - M_PI / 2 + radians, NO);
...
+ (void) initialize
{
    ...
    [appearance setIndeterminateDuration:8.0f];
