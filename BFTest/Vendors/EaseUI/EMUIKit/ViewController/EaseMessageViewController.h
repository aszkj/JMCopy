...
@property (strong, nonatomic) BFChatInputBar *chatToolbar;

@property(strong, nonatomic) BFChatMoreView *chatBarMoreView;

@property (nonatomic,strong) BFPhotoPicker *photoPickerView;
@property(strong, nonatomic) EaseFaceView *faceView;

@property(strong, nonatomic) BFVedioView *recordView;
...
@property (strong, nonatomic) NSString *jmid;
