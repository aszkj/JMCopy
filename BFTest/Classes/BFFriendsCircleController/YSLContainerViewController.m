...
- (void)viewDidLoad {
    ...
    _contentScrollView.frame = CGRectMake(0,_topBarHeight, Screen_width, Screen_height - (_topBarHeight + NavBar_Height));
...
//    _menuView.backgroundColor = [UIColor clearColor];
    ...
    _menuView.viewbackgroudColor = BFColor(37, 38, 39, 1);
    _menuView.itemfont = BFFontOfSize(15);
    _menuView.itemTitleColor = [UIColor whiteColor];
    _menuView.itemIndicatorColor = BFColor(248, 212, 47, 1);
